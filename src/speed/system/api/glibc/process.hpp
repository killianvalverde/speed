...
/**
 * @file        speed/system/api/glibc/process.hpp
 * @brief       glibc process main header.
 * @author      Killian Green
 * @date        2023/10/31
 */

#ifndef SPEED_SYSTEM_API_GLIBC_PROCESS_HPP
#define SPEED_SYSTEM_API_GLIBC_PROCESS_HPP

#include "../../type_traits.hpp"
#ifdef SPEED_GLIBC

#include "process/operations.hpp"
