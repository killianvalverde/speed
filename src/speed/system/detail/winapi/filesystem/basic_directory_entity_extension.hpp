...
#ifndef SPEED_SYSTEM_DETAIL_WINAPI_FILESYSTEM_BASIC_DIRECTORY_ENTITY_EXTENSION_HPP
#define SPEED_SYSTEM_DETAIL_WINAPI_FILESYSTEM_BASIC_DIRECTORY_ENTITY_EXTENSION_HPP
...
using speed::system::detail::winapi::filesystem::basic_directory_entity_extension;
