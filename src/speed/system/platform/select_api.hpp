...
/** @cond */
#ifdef SPEED_GLIBC
#define SPEED_API_PREFIX_HELPER 1, ::speed::system::detail::glibc
#elif defined(SPEED_WINAPI)
#define SPEED_API_PREFIX_HELPER 1, ::speed::system::detail::winapi
#else
#define SPEED_API_PREFIX_HELPER 0
#endif

#define SPEED_GET_PARAM2_HELPER(a, b, ...) b
#define SPEED_GET_PARAM2(...) SPEED_GET_PARAM2_HELPER(__VA_ARGS__)
#define SPEED_API_DEFINED_YES(a, b, ...) SPEED_GET_PARAM2(SPEED_API_PREFIX_HELPER)::a(__VA_ARGS__)
...
#define SPEED_SELECT_API(a, b, ...) SPEED_CONCAT(SPEED_API_DEFINED_,\
        SPEED_IS_API_DEFINED(SPEED_API_PREFIX_HELPER))(a, b, __VA_ARGS__)
/** @endcond */
