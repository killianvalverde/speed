...
/**
 * @file       speed/containers/mutable_iterator_base.hpp
 * @brief      mutable_iterator_base interface header.
 * @author     Killian Valverde
 * @date       2018/01/19
 */

#ifndef SPEED_CONTAINERS_MUTABLE_ITERATOR_BASE_HPP
#define SPEED_CONTAINERS_MUTABLE_ITERATOR_BASE_HPP
