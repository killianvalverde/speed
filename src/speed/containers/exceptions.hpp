 ...
 */
class exceptions : public speed::exceptions::runtime_exception_base
{
public:
    /**
 ...
 */
class insertion_exception : public exceptions
{
public:
    /**
     * @brief       Get the message of the exception.
 ...
 *              container error
 */
class empty_container_exception : public exceptions
{
public:
    /**
     * @brief       Get the message of the exception.
 ...
 *              out-of-range error
 */
class out_of_range_exception : public exceptions
{
public:
    /**
     * @brief       Get the message of the exception.
 ...
 */
class exhausted_resources_exception : public exceptions
{
public:
    /**
     * @brief       Get the message of the exception.
 ...
 * @brief       Class used to throw exceptions when an insertion error occurs.
 */
class bad_iteration_exception : public exceptions
{
public:
    /**
     * @brief       Get the message of the exception.
