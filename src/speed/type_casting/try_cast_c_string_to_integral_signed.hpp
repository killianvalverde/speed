...
/**
 * @file        speed/type_casting/try_cast_c_string_to_integral_signed.hpp
 * @brief       try_cast_c_string_to_integral_signed main header.
 * @author      Killian Valverde
 * @date        2016/08/19
 */

#ifndef SPEED_TYPE_CASTING_TRY_CAST_C_STRING_TO_INTEGRAL_SIGNED_HPP
#define SPEED_TYPE_CASTING_TRY_CAST_C_STRING_TO_INTEGRAL_SIGNED_HPP
