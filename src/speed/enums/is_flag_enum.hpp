 ...
 * @brief Type trait and bitwise operator support for flag enumerations.
...
[[nodiscard]] constexpr LhsT operator |(LhsT lhs, RhsT rhs) noexcept
{
...
[[nodiscard]] constexpr LhsT operator ~(LhsT lhs) noexcept
{
    using lhs_underlying_type = type_traits::underlying_type_of_t<LhsT>;
