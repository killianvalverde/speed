...
/**
 * @file        speed/filesystem/write_path_decorator.hpp
 * @brief       write_path_decorator main header.
 * @author      Killian Valverde
 * @date        2024/05/20
 */

#ifndef SPEED_FILESYSTEM_WRITE_PATH_DECORATOR_HPP
#define SPEED_FILESYSTEM_WRITE_PATH_DECORATOR_HPP
