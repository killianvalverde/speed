...
/**
 * @file        speed/filesystem/directory_path_decorator.hpp
 * @brief       directory_path_decorator main header.
 * @author      Killian Valverde
 * @date        2024/05/20
 */

#ifndef SPEED_FILESYSTEM_DIRECTORY_PATH_DECORATOR_HPP
#define SPEED_FILESYSTEM_DIRECTORY_PATH_DECORATOR_HPP
