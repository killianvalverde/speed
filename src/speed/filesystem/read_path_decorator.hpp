...
/**
 * @file        speed/filesystem/read_path_decorator.hpp
 * @brief       read_path_decorator main header.
 * @author      Killian Valverde
 * @date        2024/05/20
 */

#ifndef SPEED_FILESYSTEM_READ_PATH_DECORATOR_HPP
#define SPEED_FILESYSTEM_READ_PATH_DECORATOR_HPP
...
public:
    ...
    [[nodiscard]] bool is_valid(std::error_code* err_code = nullptr) override
    {
       ...
       // std::filesystem::file_status fle_status = std::filesystem::status(*this, err_code);
       // if (!err_code && (fle_status.permissions() & std::filesystem::perms::owner_read) !=
