 ...
 */
class exceptions : public exceptions::exception_base
{
public:
    /**
 ...
 */
class no_key_specified_exception : public exceptions
{
public:
    /**
     * @brief       Get the message of the exception.
 ...
 */
class no_value_id_specified_exception : public exceptions
{
public:
    /**
     * @brief       Get the message of the exception.
 ...
 */
class no_help_menu_id_specified_exception : public exceptions
{
public:
    /**
     * @brief       Get the message of the exception.
 ...
 */
class key_already_exists_exception : public exceptions
{
public:
    /**
     * @brief       Get the message of the exception.
 ...
 *              add another.
 */
class version_already_exists_exception : public exceptions
{
public:
    /**
     * @brief       Get the message of the exception.
 ...
 *              add another.
 */
class help_menu_already_exists_exception : public exceptions
{
public:
    /**
     * @brief       Get the message of the exception.
 ...
 */
class key_not_found_exception : public exceptions
{
public:
    /**
     * @brief       Get the message of the exception.
 ...
 */
class version_not_found_exception : public exceptions
{
public:
    /**
     * @brief       Get the message of the exception.
 ...
 * @brief       Class used to thrown exceptions when an argument value is not found.
 */
class value_not_found_exception : public exceptions
{
public:
    /**
     * @brief       Get the message of the exception.
 ...
 * @brief       Class used to thrown exceptions when a help menu is not found.
 */
class help_menu_not_found_exception : public exceptions
{
public:
    /**
     * @brief       Get the message of the exception.
 ...
 */
class wrong_constraint_exception : public exceptions
{
public:
    /**
     * @brief       Get the message of the exception.
 ...
 */
class wrong_description_exception : public exceptions
{
public:
    /**
     * @brief       Get the message of the exception.
 ...
 *              incoherent.
 */
class wrong_min_max_interval_exception : public exceptions
{
public:
    /**
     * @brief       Get the message of the exception.
 ...
 *              incoherent.
 */
class wrong_max_occurrences_exception : public exceptions
{
public:
    /**
     * @brief       Get the message of the exception.
 ...
 *              incoherent.
 */
class arguments_not_parsed_exception : public exceptions
{
public:
    /**
     * @brief       Get the message of the exception.
