...
#ifndef SPEED_ARGPARSE_DETAIL_HELP_MENU_FLAGS_HPP
#define SPEED_ARGPARSE_DETAIL_HELP_MENU_FLAGS_HPP
...
/** @cond */
template<>
struct speed::scalars::is_flag_enum<speed::argparse::detail::help_menu_flags>
        : std::true_type {};
/** @endcond */
