...
#ifndef SPEED_ARGPARSE_DETAIL_BASIC_HELP_MENU_SETTER_HPP
#define SPEED_ARGPARSE_DETAIL_BASIC_HELP_MENU_SETTER_HPP
...
public:
     ...
     */
    basic_help_menu_setter(help_menu_type* hlp_menu)
            : hlp_menu_(hlp_menu)
    {
    }
    ...
    {
        hlp_menu_->set_description(std::forward<StringT_>(desc));
        return *this;
    }
     ...
     */
    template<typename StringT_>
    self_type& epilogue(StringT_&& epilg)
    {
        hlp_menu_->set_epilog(std::forward<StringT_>(epilg));
        return *this;
    }
