...
/**
 * @file        arg_value_error_flags.hpp
 * @brief       arg_value_error_flags enum class header.
 * @author      Killian Valverde
 * @date        2016/08/06
 */

#ifndef SPEED_ARGPARSE_DETAIL_ARG_VALUE_ERROR_FLAGS_HPP
#define SPEED_ARGPARSE_DETAIL_ARG_VALUE_ERROR_FLAGS_HPP
...
enum class arg_value_error_flags : std::uint8_t
{
    ...
    /** The argument value assertion fails. */
    ASSERTION_ERROR = 0x1,
    
    /** The argument value has not matched the regex. */
    REGEX_MATCH_ERROR = 0x2,
...
/** @cond */
template<>
struct speed::scalars::is_flag_enum<speed::argparse::detail::arg_value_error_flags>
        : std::true_type {};
/** @endcond */
