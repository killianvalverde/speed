...
class basic_key_value_arg_setter
        : public type_traits::basic_crtp_base_t<basic_key_arg_setter,
                basic_key_value_arg_setter, ActualT, std::false_type, AllocatorT>
        , public type_traits::basic_crtp_base_t<basic_value_arg_setter,
                basic_key_value_arg_setter, ActualT, std::false_type, AllocatorT>
{
public:
    ...
    using self_type = type_traits::basic_crtp_self_t<basic_key_value_arg_setter,
