...
#ifndef SPEED_ARGPARSE_DETAIL_BASIC_VALUE_ARG_SETTER_HPP
#define SPEED_ARGPARSE_DETAIL_BASIC_VALUE_ARG_SETTER_HPP
...
class basic_value_arg_setter : virtual public basic_base_arg_setter<AllocatorT, ActualT>
{
public:
    ...
    using base_arg_setter_type = basic_base_arg_setter<AllocatorT, ActualT>;
     ...
     */
    basic_value_arg_setter(value_arg_type* val_arg)
     ...
     */
    basic_value_arg_setter(const basic_value_arg_setter& rhs) = delete;
    
    /**
     * @brief       Move constructor.
     * @param       rhs : Object to move.
     */
    basic_value_arg_setter(basic_value_arg_setter&& rhs) noexcept = delete;
     ...
     */
    basic_value_arg_setter& operator =(const basic_value_arg_setter& rhs) = delete;
     ...
     * @return      The object who call the method.
     */
    basic_value_arg_setter& operator =(basic_value_arg_setter&& rhs) noexcept = delete;
    ...
    self_type& assertions(AssertionTs_&&... assertns)
    {
        dynamic_cast<value_arg_type*>(base_arg_setter_type::bse_arg_)
                ->set_assertions(std::forward<AssertionTs_>(assertns)...);
    ...
    self_type& regexes(RegexTs_&&... regxes)
    {
        dynamic_cast<value_arg_type*>(base_arg_setter_type::bse_arg_)
                ->set_regexes(std::forward<RegexTs_>(regxes)...);
        return dynamic_cast<self_type&>(*this);
    }
    ...
    self_type& store_into(HolderTs_&... holdrs)
    {
        dynamic_cast<value_arg_type*>(base_arg_setter_type::bse_arg_)
                ->set_holders(holdrs...);
        return dynamic_cast<self_type&>(*this);
