...
#ifndef SPEED_ARGPARSE_DETAIL_ARG_ERROR_FLAGS_HPP
#define SPEED_ARGPARSE_DETAIL_ARG_ERROR_FLAGS_HPP
...
/** @cond */
template<>
struct speed::scalars::is_flag_enum<speed::argparse::detail::arg_error_flags>
        : std::true_type {};
/** @endcond */
