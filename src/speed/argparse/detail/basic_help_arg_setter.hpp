...
class basic_help_arg_setter : public type_traits::basic_crtp_base_t<basic_key_arg_setter,
...
public:
    ...
    using key_value_arg_setter_type = type_traits::basic_crtp_base_t<
    ...
    using self_type = type_traits::basic_crtp_self_t<basic_help_arg_setter,
