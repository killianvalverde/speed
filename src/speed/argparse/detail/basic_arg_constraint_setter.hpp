...
#ifndef SPEED_ARGPARSE_DETAIL_BASIC_ARG_CONSTRAINT_SETTER_HPP
#define SPEED_ARGPARSE_DETAIL_BASIC_ARG_CONSTRAINT_SETTER_HPP
...
public:
    ...
    using arg_constraint_type = basic_arg_constraint<AllocatorT>;
     ...
     */
    basic_arg_constraint_setter(arg_constraint_type* arg_constrnt)
