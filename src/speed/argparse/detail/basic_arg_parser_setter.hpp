...
#ifndef SPEED_ARGPARSE_DETAIL_BASIC_ARG_PARSER_SETTER_HPP
#define SPEED_ARGPARSE_DETAIL_BASIC_ARG_PARSER_SETTER_HPP
...
public:
     ...
     */
    basic_arg_parser_setter(arg_parser_type* arg_parsr)
    ...
    self_type& error_id(StringT_&& err_id) noexcept
    {
        arg_parsr_->set_error_id(std::forward<StringT_>(err_id));
        return *this;
    }
    ...
    self_type& long_prefixes(StringTs_&&... prefxs)
    {
        arg_parsr_->set_long_prefixes(std::forward<StringTs_>(prefxs)...);
        return *this;
    }
     ...
     */
    template<typename StringT_>
    self_type& program_name(StringT_&& prog_name)
    {
        arg_parsr_->set_program_name(std::forward<StringT_>(prog_name));
        return *this;
    }
     ...
     */
    template<typename... StringTs_>
    self_type& short_prefixes(StringTs_&&... prefxs)
    {
        arg_parsr_->set_short_prefixes(std::forward<StringTs_>(prefxs)...);
        return *this;
    }
