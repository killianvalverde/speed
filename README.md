...
The primary reason I created this library, instead of using alternatives like Boost, was to ensure 
that these resources worked exactly as I wanted. Every library has its own philosophy, and Speed 
reflects my approach to software development.
...
types.
- exception : The exception module defines the base class for all exceptions thrown by speed's 
...
version that is equal to or higher than the specified versions:
- GCC 8.3.0
- CMake 3.15
- Google Test 1.8

If you encounter any issues while trying to install Google Test on your system, you can obtain it 
from my fork of the original project by following this link: 
https://github.com/KillianValverde/googletest

Google Test is also a CMake-based project. You can use the following steps, which describe how to 
build Speed as a standalone project, to achieve the same for Google Test and install it on your 
system.
